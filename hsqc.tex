...
This arises partly because of the use of the PEP sensitivity enhancement scheme, in which the reverse INEPT transfer delays $\Delta'$ can optimised for \ce{NH} peaks.
