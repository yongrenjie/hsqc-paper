...
\begin{figure}
    ...
    {\phantomsubcaption\label{fig:pprogs_hmqc}}
    {\phantomsubcaption\label{fig:pprogs_hsqc}}
    ...
    \caption{
        ...
        \textbf{\subref{fig:pprogs_hmqc}} NOAH HMQC module,\autocite{Kupce2017ACIE, Kupce2007MRC} abbreviated as ``M''.
        \textbf{\subref{fig:pprogs_hsqc}} NOAH HSQC module without sensitivity enhancement,\autocite{Kupce2017ACIE, Schulze-Sunninghausen2017JMR} abbreviated as ``S''.
...
\begin{figure}
    ...
    \caption{
        ...
        \textbf{\subref{fig:sehsqc_comp_ex_ch}} Slices of the NOAH HSQC (dashed line) and NOAH ZIP-seHSQC (\noahSpb{}) spectra (solid line) through $f_1 = \SI{78.9}{\ppm}$ (a \ce{CH} peak).
        \textbf{\subref{fig:sehsqc_comp_ex_ch2}} Slices of the NOAH HSQC (dashed line) and NOAH ZIP-seHSQC spectra (solid line) through $f_1 = \SI{28.5}{\ppm}$ (a \ce{CH2} peak).
...
Multiplicity editing can be easily incorporated into both NOAH seHSQC sequences (\cref{fig:edited_sehsqc_pprog}) by expanding the spin echo immediately following $t_1$.
\hl{
...
Although the \noahSpb{} module retains a slightly smaller amount of \magnnot{\ce{N}} magnetisation ($\sim 70\%$, versus $\sim 80\%$ for the HMQC (\cref{fig:n15_bulk_retention})), this is almost never a problem, since it is the \nitrogen{} module which typically has the lowest intrinsic sensitivity in a supersequence.
...
\begin{figure}
    ...
    \caption{
        ...
        \hl{The \noahSpa{} module is not shown here as it causes severe line broadening downstream modules (see text).}
        ...
        \textbf{\subref{fig:15n_spv2vsm_hmqc_proj}} Projection of seHSQC onto the $f_1$ axis.
...
Here, we illustrate this with the NOAH-4 \noahfour{Spn}{St}{Spb}{Cc} (\nitrogen{} seHSQC, \carbon{} HSQC-TOCSY, \carbon{} seHSQC, and CLIP-COSY) supersequence (\cref{fig:example_spec}).
