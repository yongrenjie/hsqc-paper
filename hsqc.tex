...
\begin{figure}
    ...
    \caption{
        ...
        \textbf{\subref{fig:sehsqc_comp_crk}} Using the original CRK seHSQC.
        ...
        \textbf{\subref{fig:sehsqc_comp_ex_ch}} Slices of the NOAH HSQC (dashed line) and NOAH seHSQC spectra (solid line) through $f_1 = \SI{78.9}{\ppm}$ (a \ce{CH} peak).
        \textbf{\subref{fig:sehsqc_comp_ex_ch2}} Slices of the NOAH HSQC (dashed line) and NOAH seHSQC spectra (solid line) through $f_1 = \SI{28.5}{\ppm}$ (a \ce{CH2} peak).
        \textbf{\subref{fig:sehsqc_comp_ex_cosy}} Slices of the CLIP-COSY module in a NOAH-2 \noahtwo{S}{Cc} supersequence (dashed line) and NOAH-2 \noahtwo{Sp}{Cc} (solid line) through $f_1 = \SI{1.36}{\ppm}$.
        \andro{}
    }
...
Compared to this, the new \noahSpb{} module can provide greater than $4\times$ enhanced sensitivity (\figref{n15}).
...
Although the \noahSpb{} module retains a slightly smaller amount of \magnnot{\ce{N}} magnetisation ($\sim 70\%$, versus $\sim 80\%$ for the HMQC (\figref{n15_bulk_retention})), this is almost never a problem, since it is the \nitrogen{} module which typically has the lowest intrinsic sensitivity in a supersequence.
...
For typical organic molecules, new supersequences such as the NOAH-4 \noahfour{St}{Spb}{C}{T} allow the rapid and complete collection of \ce{C-H} and \ce{H-H} correlations (\figref{stspct}).
