...
Since the seHSQC module does not preserve unused $\onejch$ magnetisation, the HSQC-TOCSY in a hypothetical SpStC supersequence will have greatly reduced sensitivity.
...
\begin{figure}
    ...
    \caption{
        Comparison of signal intensities of second (HSQC or seHSQC) and third (CLIP-COSY) modules in the StSCc and StSpCc supersequences, versus their intensities in the SSCc and SSpCc sequences, as a function of the parameter $f$.
