...
For \nitrogen{}--\proton{} correlations, both the HMQC and version 2 of the new seHSQC are recommended as they keep the bulk magnetisation (both \magn{\ce{C}} and \magnnot{\ce{X}}) along $\pm z$ during the $t_1$ period.
...
\begin{figure}
    ...
    \caption{
        ...
        The peak at $\delta_{\ce{H}} = \SI{8.03}{\ppm}$ in \subref{fig:hmqc_kscale_k2}--\subref{fig:hmqc_kscale_k8} is a folded peak from the ornithine \textdelta-\ce{NH2}.
        \textbf{\subref{fig:hmqc_kscale_std}} The ``standard'' spectrum with $\mathrm{SW} = \SI{30}{\ppm}$, $k = 1$, 256 $t_1$ increments, and 2 scans per increment (denoted as $30:256:2$; AQ = \SI{60.1}{\ms}).
        \textbf{\subref{fig:hmqc_kscale_k2}} $k = 2$, i.e.\ effectively 128 $t_1$ increments and 4 scans per increment ($30:128:4$; AQ = \SI{30.1}{\ms}).
        \textbf{\subref{fig:hmqc_kscale_k4}} $k = 4$ ($30:64:8$; AQ = \SI{15.0}{\ms}).
        \textbf{\subref{fig:hmqc_kscale_k8}} $k = 8$ ($30:32:16$; AQ = \SI{7.5}{\ms}).
        \textbf{\subref{fig:hmqc_kscale_sw2}} SW = \SI{60}{\ppm} ($60:256:2$; AQ = \SI{30.1}{\ms}).
        \textbf{\subref{fig:hmqc_kscale_sw4}} SW = \SI{120}{\ppm} ($120:256:2$; AQ = \SI{15.0}{\ms}).
        \textbf{\subref{fig:hmqc_kscale_sw8}} SW = \SI{240}{\ppm} ($240:256:2$; AQ = \SI{7.5}{\ms}).
...
\begin{figure}
    ...
    \caption{
        ...
        \nitrogen{} seHSQC spectra taken from NOAH-3 \noahthree{Spn}{Spb}{Cc} supersequences; see caption of \cref{fig:hmqc_kscale} for more explanation.
        All 2D spectra are plotted with the same contour levels, and all 1D projections are plotted with the same noise level.
        No linear prediction has been applied beyond the default processing in TopSpin (see text above).
        \textbf{\subref{fig:spv2_kscale_std}} The ``standard'' spectrum with $\mathrm{SW} = \SI{30}{\ppm}$, $k = 1$, 256 $t_1$ increments, and 2 scans per increment (denoted as $30:256:2$; AQ = \SI{60.1}{\ms}).
        \textbf{\subref{fig:spv2_kscale_k2}} $k = 2$, i.e.\ effectively 128 $t_1$ increments and 4 scans per increment ($30:128:4$; AQ = \SI{30.1}{\ms}).
        \textbf{\subref{fig:spv2_kscale_k4}} $k = 4$ ($30:64:8$; AQ = \SI{15.0}{\ms}).
        \textbf{\subref{fig:spv2_kscale_k8}} $k = 8$ ($30:32:16$; AQ = \SI{7.5}{\ms}).
        \textbf{\subref{fig:spv2_kscale_sw2}} SW = \SI{60}{\ppm} ($60:256:2$; AQ = \SI{30.1}{\ms}).
        \textbf{\subref{fig:spv2_kscale_sw4}} SW = \SI{120}{\ppm} ($120:256:2$; AQ = \SI{15.0}{\ms}).
        \textbf{\subref{fig:spv2_kscale_sw8}} SW = \SI{240}{\ppm} ($240:256:2$; AQ = \SI{7.5}{\ms}).
...
\begin{figure}
    ...
    \caption{
        ...
        All 2D spectra are plotted with the same contour levels, and all 1D projections are plotted with the same noise level.
        \textbf{\subref{fig:hmqc_kscale_lp_std}} The ``standard'' spectrum with $\mathrm{SW} = \SI{30}{\ppm}$, $k = 1$, 256 $t_1$ increments (linear predicted to 512 indirect-dimension points), and 2 scans per increment (denoted as $30:256:2$; AQ = \SI{60.1}{\ms}).
        \textbf{\subref{fig:hmqc_kscale_lp_k2}} $k = 2$, i.e.\ effectively 128 $t_1$ increments and 4 scans per increment ($30:128:4$), linear predicted to 512 points.
        \textbf{\subref{fig:hmqc_kscale_lp_k4}} $k = 4$ ($30:64:8$), linear predicted to 512 points.
        \textbf{\subref{fig:hmqc_kscale_lp_k8}} $k = 8$ ($30:32:16$), linear predicted to 512 points.
        \textbf{\subref{fig:hmqc_kscale_lp_sw2}} SW = \SI{60}{\ppm} ($60:256:2$; AQ = \SI{30.1}{\ms}), linear predicted to 1024 points.
        \textbf{\subref{fig:hmqc_kscale_lp_sw4}} SW = \SI{120}{\ppm} ($120:256:2$; AQ = \SI{15.0}{\ms}), linear predicted to 2048 points.
        \textbf{\subref{fig:hmqc_kscale_lp_sw8}} SW = \SI{240}{\ppm} ($240:256:2$; AQ = \SI{7.5}{\ms}), linear predicted to 4096 points.
        ...
        Numbers indicate signal-to-noise ratios relative to the ``standard'' HMQC spectrum in \subref{fig:hmqc_kscale_lp_std}, obtained by dividing the relative peak height by the increase in noise (linear prediction of $k$ times more points leads to a $\sqrt{k}$ increase in noise).
        \grami{}
    }
...
\begin{figure}
    ...
    \caption{
        ...
        \textbf{\subref{fig:spv2_kscale_lp_k2}} $k = 2$, i.e.\ effectively 128 $t_1$ increments and 4 scans per increment ($30:128:4$), linear predicted to 512 points.
        \textbf{\subref{fig:spv2_kscale_lp_k4}} $k = 4$ ($30:64:8$), linear predicted to 512 points.
        \textbf{\subref{fig:spv2_kscale_lp_k8}} $k = 8$ ($30:32:16$), linear predicted to 512 points.
        \textbf{\subref{fig:spv2_kscale_lp_sw2}} SW = \SI{60}{\ppm} ($60:256:2$; AQ = \SI{30.1}{\ms}), linear predicted to 1024 points.
        \textbf{\subref{fig:spv2_kscale_lp_sw4}} SW = \SI{120}{\ppm} ($120:256:2$; AQ = \SI{15.0}{\ms}), linear predicted to 2048 points.
        \textbf{\subref{fig:spv2_kscale_lp_sw8}} SW = \SI{240}{\ppm} ($240:256:2$; AQ = \SI{7.5}{\ms}), linear predicted to 4096 points.
        ...
        Numbers indicate signal-to-noise ratios relative to the ``standard'' seHSQC spectrum in \subref{fig:spv2_kscale_lp_std}, obtained by dividing the relative peak height by the increase in noise (linear prediction of $k$ times more points leads to a $\sqrt{k}$ increase in noise).
        \grami{}
    }
