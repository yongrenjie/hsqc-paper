...
This does not compromise the HSQC-TOCSY intensity by much, and at the same time yields either a HSQC with $\sim 60\%$ of its original sensitivity, or a seHSQC which has $\sim 75\%$ of the sensitivity of a standard NOAH HSQC.

If the sensitivity of the HSQC-TOCSY component is to be maximised, then it is advisable to use the seHSQC-TOCSY module, which is based on the \noahSpb{} module and is described in ref.\ \citenum{Hansen2021} of the main text.
