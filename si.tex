...
\hl{Although the CRK seHSQC has slightly better performance over the NOAH seHSQCs, its major drawback remains} in that it does not preserve any \magnnot{\ce{X}} magnetisation for a subsequent homonuclear module (\cref{fig:1_4j_unedited_crk}): the duration of $\Delta'$ chosen does not affect this in any way.
...
\hl{This is generally not desirable} in a \carbon{} seHSQC, where \ce{CH2} peaks are common and are often further split due to diastereotopicity.
