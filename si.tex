...
\begin{enumerate}
    ...
    \item SW-scaling: increasing the indirect-dimension spectral window (SW) by a factor of $k$ (but leaving TD1 and NS unchanged) leads to an equivalent decrease in AQ.
\end{enumerate}
...
Although this leads to larger increases in peak height or SNR (by virtue of the decreased linewidths), this does not necessarily represent a true ``sensitivity gain'' in terms of its ability to reveal weak peaks.\autocite{Stern2002JACS}
...
\begin{itemize}
    \item The sensitivity gains obtained without extra linear prediction (\cref{fig:hmqc_kscale,fig:spv2_kscale}) are almost identical in both cases.
